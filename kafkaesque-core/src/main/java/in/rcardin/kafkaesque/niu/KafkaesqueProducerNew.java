...
import in.rcardin.kafkaesque.niu.KafkaesqueProducerNew.KafkaesqueProducerDelegate.DelegateCreationInfo;
 ...
 * @see Builder
 */
public final class KafkaesqueProducerNew<Key, Value> {
  ...
  /**
   * Creates instances of {@link KafkaesqueProducerNew}.<br/>
  ...
  public static class Builder<Key, Value> {
    ...
    /**
     * Creates an instance of the {@link KafkaesqueProducerNew}. Before the creation, performs a set of
     * validation steps.
     *
     * @return An instance of the {@link KafkaesqueProducerNew}
     */
    public KafkaesqueProducerNew<Key, Value> expecting() {
      validateInputs();
      final DelegateCreationInfo<Key, Value> creationInfo = new DelegateCreationInfo<>(
          topic, keySerializer, valueSerializer);
      return new KafkaesqueProducerNew<>(
          brokerUrl,
